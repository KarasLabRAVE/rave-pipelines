...
##'
Sys.setenv("RAVE_PIPELINE" = normalizePath("/Users/dipterix/Dropbox (PennNeurosurgery)/KarasLab-RAVE/oliver-rave-pipelines/modules/fragility_explorer"))
